...
var Categories = []CommandCategory{
	...
	},
	{
		...
		Commands: []CommandInfo{
			...
			{Name: "/magic8ball", Description: "Ask the magic 8-ball a yes/no question.", Usage: "/magic8ball question:\"Will it rain?\""},
			{Name: "/remindme", Description: "Set a personal reminder delivered by DM.", Usage: "/remindme duration:1h reminder:\"Check tickets\""},
			{Name: "/say", Description: "Send a message as PulseKeep in the current channel.", Usage: "/say message:\"Maintenance in 5 minutes\""},
			{Name: "/tip", Description: "Get a random helpful PulseKeep tip.", Usage: "/tip"},
			{Name: "/vote", Description: "Get the Top.gg voting link.", Usage: "/vote"},
		},
	},
	{
		ID:          "economy",
		...
		Commands: []CommandInfo{
			...
			{Name: "/lottery-claim", Description: "Claim your prize if you won the weekly draw.", Usage: "/lottery-claim tier:low"},
			{Name: "/lottery-config", Description: "Configure auto-draw for low or high lottery tiers.", Usage: "/lottery-config tier:high autodraw:true"},
