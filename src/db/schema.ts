...
export const guildConfigs = pgTable('guild_configs', {
  ...
  automodSpamLimit: integer('automod_spam_limit').default(5),
  automodSpamWindow: integer('automod_spam_window').default(5000),
  automodMentionLimit: integer('automod_mention_limit').default(5),
  automodCapsRatio: integer('automod_caps_ratio').default(70),
  automodCapsMinLength: integer('automod_caps_min_length').default(10),
  automodTimeoutDuration: integer('automod_timeout_duration').default(10),
  automodSpamAction: varchar('automod_spam_action', { length: 10 }).default('warn'),
  automodMentionAction: varchar('automod_mention_action', { length: 10 }).default('timeout'),
  automodCapsAction: varchar('automod_caps_action', { length: 10 }).default('delete'),
  automodLinkAction: varchar('automod_link_action', { length: 10 }).default('delete'),
  automodWordsAction: varchar('automod_words_action', { length: 10 }).default('delete'),
  automodExemptRoles: text('automod_exempt_roles'),
  automodAllowedDomains: text('automod_allowed_domains'),
